...
function Onboarding() {
  ...
  return (
    <>
      ...
      >
        <div className='custom-form-box p-4 shadow-lg rounded' style={{ maxWidth: '700px', width: '100%', backgroundColor: 'white' }}>
          <div className='text-center mb-4'>
            <h3>Student Sign Up to Engage!</h3>
            <p>Create your profile to discover volunteer opportunities near you.</p>
          </div>
